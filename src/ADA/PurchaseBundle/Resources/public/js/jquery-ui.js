...
function DisableSpecificDates(date) {
	...
	var day = date.getDay();
	return [(disableddates.indexOf(string) == -1) && ( day == 1 || day == 3 || day == 4 || day == 5 || day == 6 )];

	var m = date.getMonth();
	var d = date.getDate();

	// First convert the date in to the mm-dd format
